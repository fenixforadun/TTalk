package volare.com.ttalk.Fragment;
...
import volare.com.ttalk.Chat.GroupMessageActivity;
import volare.com.ttalk.Chat.MessageActivity;
...
public class ChatFragment extends Fragment {
	...
	class ChatRecyclerViewAdapter extends RecyclerView.Adapter< RecyclerView.ViewHolder > {
		...
		public void onBindViewHolder ( RecyclerView.ViewHolder holder , final int position ) {
			...
			// 메세지를 내림차순으로 정렬 후 마지막 메세지의 키값을 참조
			...
			customViewHolder.itemView.setOnClickListener( new View.OnClickListener() {
				...
				public void onClick ( View view ) {
					...
					if ( android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.JELLY_BEAN ) {
						...
						activityOptions =
										ActivityOptions.makeCustomAnimation( view.getContext() , R.anim.fromright , R.anim.toleft );
